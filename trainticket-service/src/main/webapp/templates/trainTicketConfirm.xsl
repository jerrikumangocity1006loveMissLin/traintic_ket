    ...
    .staticData{ 
			...
			<body>
				<table width="650">
					<tr>
						<td width="400">
							<font class="title">请点击该链接进行审批:</font>
						</td>
						<td width="200">
					...
					<tr>
					    <td>Please click here for approval:</td>
					</tr>
					<tr><xsl:value-of select="trainTicketConfirm/url" /></tr>
				</table>
				...
				<table width="650">
				  ...
				  <tr>
					<td>
						<FONT class="staticData">
							订单:<xsl:value-of select="trainTicketConfirm/orderCn" />
						</FONT>
					</td>
				  </tr>
				</table>
		<table width="650" id="flightInformation" class="tdCenter">
			...
			<xsl:for-each select="trainTicketConfirm/ticketList/ticket">
			   <tr>
			...
			<tr class="backgroundGray">
               ...
               <td>
               	   <b>
               	   	<FONT class="staticData">
               	    <xsl:value-of select="trainTicketConfirm/allPrice"/>
               	    </FONT>
               	   </b>
               </td>														
		    </tr>
